...
scale_test_x <- as.data.frame(scale(wide_test_x, center = attr(scale_train, "scaled:center"), scale = attr(scale_train, "scaled:scale")))
...
# TODO: Project testing data into training space
```
